...
const InteractiveTable = () => {
    ...
    return (
        <div className="flex flex-row h-[94vh] w-[100vw] place-items-center absolute start-[15.32vw]">
            <div className=" grid grid-cols-102 gap-0 auto-rows-min place-items-center">
                {grid}
            </div>
        </div>
    )
