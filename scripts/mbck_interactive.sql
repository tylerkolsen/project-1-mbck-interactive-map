...
185	The Borken Floor After the Stairs	Golden Gem	Pig Form or Lion Form	picture 185	After ascending the long staircase towards the final boss, you'll notice a broken floor just before your exit to the left. Ground Pound the floor to open the way to the chest.
...
285	Through the Darkness and the Diamonds	Elixir	Golden Sword, Snake Form, Lion Form	picture 285	You'll need to traverse to the correct place in the giant second room of the Dark Realm. At first you'll need to navigate a large open pit with lasers, and then climb upward while a diamond enemy fires at you. Reaching the top of this presents a fork in the path. Take a right, which will take you to a diamond enemy and a cyclops. Cut through the darkness to open a path to a snake hole, and use Snake Form to climb upwards on the moss. Keep moving forward until you reach another diamond enemy, where just above is another fork. Take another right until you see blocks and a breakable floor. Use Lion Form's Charge to break through the blocks. Defeat the two diamond enemies at the end to have the chest appear.
...
696	Deciphering the Wall Codes	Golden Gem	Pig Form, at least 2 Fireballs, 2 Tornadoes, 3 Lightnings, and 2 Bombs	picture 696	This room will greet you with a spell chest, three levers and some smoke in the background. Use Pig Form's Sniffer ability to reveal a jumble of codes in different colors in the background. Each lever controls a different filter that will move across the background, revealing certain details about the order of spells that you'll need. Each filter will need to be moved into the correct position to reveal the right details, but you can also brute force this chest, as it will confirm correct inputs. The order of spells that you need is: Fireball, Fireball, Tornado, Tornado, Lightning, Bomb, Lightning, Bomb, Lightning. 
...
804	Laser Dashing in All Directions	Legendary Gem	Dragon Form, Human Form	picture 804	In the room with the majority of your forms, fly up in Dragon Form to the left. When you reach the ceiling, fly to the right until you come to an opening with multiple lasers. Switch to Human Form and dash through them. You'll need to chain your dashes together here to avoid some combinations of the red and blue lasers, along with dashing upwards near the end. As you ascend, stick to the right and keep dashing to reach safe platforms. At the end of this gauntlet is the chest. 
...
1112	Dodging the Creepy Ship	3 Rainbow Drops	Dragon Form	picture 1112	In the first section of the Dark Realm, the chest is hidden near the end at the top of the corridor. However, you'll be chased by the giant ancient ship that will cause you to take damage whenever you're in view. You'll need Dragon Form to fly over to it, but it can still be difficult with all of the enemies and damage from the ship. If you're having issues, getting the upgraded Golden Armor makes you immune to the ship's effects which will give you more freedom in getting the chest.
...
2127	Breaking Through in the Twisting Room	Legendary Gem	Morning Star, Frog Form	picture 2127	This room is covered by a rotating square. You'll need to use Frog Form's Tongue to rotate the view, so that you can see the bottom right corner. Using the Morning Star, smash through the blocks on the right to reach the chest. 
...
2539	Strike Out After the Slime Spawner	Power Gem	Dragon Form	picture 2539	Within the large entry room of the Castle of Lupia, fly up the center in Dragon Form. You'll notice a slime spawner, as well as the chest.
...
2644	Greed or Feed?	5 Rainbow Drops	None	picture 2644	When you enter the treasury room, the chest will start a dialogue with you. You can choose to pay it 500 coins, or to fight it. Fighting it will spawn a mimic similar to the fight from the Haunted Manor. Either way, your reward will be the 5 Rainbow Drops.
...
4719	Snakes and Lasers	Power Gem	Pepelogoo, Snake Form	picture 4719	After defeating the ghosts and having Pepelogoo help you out, use Snake Form to enter the snake hole on the right. Using Pepelogoo's laser, light up the bulb to move the pipe that is above you. Climb up the moss in Snake Form, moving fast as the pipe opening is timed. Beat the clock to reach the chest.
...
3084	Watch for the Mines!	Power Gem	None	picture 3084	After navigating the perilous mines, you'll come across the blue chest naturally. Make sure to keep a good distance from any mines that are moving near you.
3148	Duck and Dodge in the Dungeon	Legendary Gem	Pig Form, Lion Form, Lion Talisman, Dragon Form	picture 3148	This room will have multiple guards and moving platforms. Start by dropping below and jumping to the platform underneath the destructible blocks. Use Lion Form's Upward Charge and double jump to reach the platform above. Next, Charge to the left, jump over the hole and break through the second set of destructible blocks. Look in the bottom left to see smoke. Use Dragon Form to sneak down there, and reveal it using PIg Form's Sniffer ability. 
...
3865	Bomb with the Boulders Coming Down	Legendary Gem	Bombs	picture 3865	After the room with the four torches, boulders will spawn and follow the sloped path downward. Looking to the left, you'll see a sport of the wall covered in blocks. Use bombs on the blocks to open the room to the chest.
...
4398	Reflection Suggestion	Living Room Key	Knight Gleam-Targe	picture 4398	Once you have the light beam travelling from the east wing of the Haunted Manor into the main room, stand on the small wooden platform in the center to open a hole in the ceiling. Use the Knight Gleam-Targe to reflect the beam upwards, hitting the bulb after bouncing amongst the mirrors. This will open the gate to the left. Enter to have your view flipped upside down, where you'll need to navigate to the top right to get the chest.
...
4704	Utilizing Stored Flame	Legendary Gem	Dragon Form	picture 4704	You'll notice the giant tank on the left side, along with a button on the floor. Ground pounding the button will move the tank up and down. Place the tank at the bottom position, and then use Dragon Form's fireball to send a stream of flame from the tank to the wall behind. This will open the way to the next room. Next, position the tank in the middle, and breath fire once again. This will shoot a stream of flame at the strange statue, causing it to convert into a dimensional portal. Move the tank again, enter the dimensional portal and run to the room on your left. Possess the chandelier and bring it down to open the gate that is blocking the chest.
4716	Spiked Ball goes for a Roll	Legendary Gem	None	picture 4716	Upon entering th room, you'll notice the chest above you. Striking the barrel near it reveals a button that creates a ramp from the stairs towards the right. You'll need to hit this button, run to the dimensional portal, possess the spiked ball, and roll to the left. Once up the ramp, the platform will act as an elevator to bring you higher. Continue rolling and hopping to the left to break the block in front of the chest.
...
2983	The Best Place to Hide Your Ship Key	Pirate Ship Key	Frog Form	picture 2983	In the vertical hallway with currents leading upward, reach the halfway point where the next set of currents begins. Use the slingshot on the right, and then look for two more slingshots to use in order to reach the chest.
3051	Follow Your Nose	Power Gem	Pig Form	picture 3051	While descending through the prison, you'll spot some smoke to the right past the first guard. Use Pig Form's Sniffer ability to reveal a lever. Striking the lever will drop a ladder to get past the second guard. Next, climb the ladder behind this one to go up to the chest.
...
4279	Fly to the Sky	Legendary Gem	Dragon Form	picture 4279	After finding the Fast Travel point, switch to Dragon Form and fly upwards. You'll end up in a new room with the chest.
4386	Supernatural Journey through Deadwood Graveyard	Haunted Manor Key	Dragon Form	picture 4386	In this long horizontal corridor, you'll be chasing ghosts who are trying to keep a chest from you. At first the chest will be out in the open. Shooting fireballs at the chest will cause the 99 counter to go down, but eventually the ghosts will move the chest away. You'll be chasing the ghosts throughout this area, landing fireballs on the chest whenever you can. The chest will move five times with various obstacles thrown at you. At the final move, a group of ghosts will attack, including yellow ghosts that will try to teleport behind you when you swing at them. Keep being persistent and eventually the chest will open.
...
4501	Monster Mimic Attacks	Knight Gleam-Targe	None	picture 4501	When you enter the room, you'll notice a chest in the open. As you get closer, a ghost will possess it. Trying to open the chest will cause the chest to come to life as a mimic and jump around the room. Walk under it as it jumps, and attack when you get an opening. Once defeated, you'll be able to open the chest normally.
4610	Possessing the Chandelier	Elixir	None	picture 4610	This area in the greenhouse is covered in black vines. Go to the room above it to find a statue. A ghost will quickly possess it, and to complicate matters a skeleton will appear from a closet. Defeat the skeleton to spawn a dimensional portal, then possess the statue to go after the green ghost. Once the green ghost is gone, you can possess the statue and hop it to the left. Destroy the blocks in the floor to the right to open the way for the chandelier. Possess the chandelier and move it downwards until it breaks free. You can now use the chandelier to cut through each of the vines in the greenhouse. Once you've removed all five vines, the chest will spawn in some poison water.
...
4817	Snakes in the Tub	Legendary Gem	None	picture 4817	In the outside area with the large tree, make sure that you've unlocked all of the dimensional portals by chasing the pink ghost and striking it. There will be a total of three portals that you can unlock. At the very top, possess the spiked ball and fall to the right. You'll need to pick up speed and hop over any pits until you smash into the manor on the left side. This will open up the bathroom, which you can then use the Knight Gleam-Targe to unlock on the inside. You'll want to go into the snake hole that is contained in the tub to warp to the basement. You'll need to go through the poisoned water, avoiding the red ghosts to make it to the end with the chest. The red ghosts will damage you if you get too close and will also grow in size, but they can be defeated. 
...
3151	Subterfuge for the Prison Key	Prison Key	Snake Form	picture 3151	You can't approach this chest from the front door, due to the guards. Head to the elevator shaft and take the bottom right exit. You'll trigger a memory mini-game with the guard, who'll ask about the meal they had. The information from this can be gleaned from the prison cell you're taken to when caught. You'll need to answer three correctly: Round vegetable eaten the most is Tomato; Color of King's favorite tomato is Blue; Holes in Cheese is 14; The password never used is A Chicken; The baked good by mixing all other passwords is Pizza. After answering correctly the guard will leave. You'll next need to avoid guards and climb upwards. Eventually there will be two snake holes; take the hole on the left to get to the chest.
...
4295	Going Against the Conveyor Belt Flow	Power Gem	Pepelogoo	picture 4295	Use Pepelogoo's laser to spawn a spiked ball, and direct it down to the third conveyer. You'll know it's the correct one if there are no spikes on the left side. Send the spiked ball into the wall, which will open up a secret room that contains the chest.
4397	Chasing Down the Ghost Thief	Mansion Chapel Key	None	picture 4397	At first the chest will be in plain sight, but once you attempt to open it, a ghost will come and steal it. The ghost thief will enter each of the pieces of furniture in the room, which will require you to enter the dimensional portal and chase after it. Each object is its own puzzle, requiring you to traverse and avoid the giant purple orbs that slowly follow after you. Your goal is to destroy white blocks by using the white orbs you find in each fixture. The cupboard consists of straightforward platforming to reach the orb, which you then push to the left to complete. The globe has a rotating outer ring with moss that you can use with Snake Form to push each of the two orbs. Next will be the lock. Once you head to the top, the ghost will spring an unavoidable trap that will throw you out. Jump into the lock again to complete the puzzle proper. You'll need to push the orb past moving spikes, so take your time and wait for the right moment. The final challenge is the statue, which will have you flipping levers to have a beam of light reach the bulb at the bottom. Each time you hit a lever, the ghost will also flip a lever on the other side. You can use this against the ghost, but if you'd like the puzzle solution proper, it is hitting the top lever three times, the middle lever once and the bottom lever three times. With the gate at the top now open, you can push the orb to the right. Finally, the ghost will have nowhere to go and will attack you. Defeat it to have the chest appear.
4497	Hidden Drops in the Haunted Manor	3 Rainbow Drops	None	picture 4497	After entering the large room with many flying books, head to the top left corner. Rather than trying to go through the top most exit, head down and to the left to the enclosed hallways with a pedestal at the end. The left wall has a block here that can be pushed. Push it in to gain entry, and then attack the books on the highest platform to reveal the chest.
...
4810	Setting Up the Spiked Ball	Power Gem	None	picture 4810	When entering this basement room, you'll come across the dimensional portal in the center. This allows you to enter another dimension and possess props nearby, though you are on a timer to do so. Using the dimensional portal, possess the two tables and place them over the water gaps in the center of the room. Next, possess the spiked ball on the left, and roll it to the right while using the tables to cross the gaps. Destroy the block in the lower right to access the chest.
